...
#define PORTA_PIN0_DIR      1 //for LED
...
#define PORTB_PIN4_DIR      0 /*SS PIN input pulled up at Master*/
#define PORTB_PIN5_DIR      1 /*MOSI: Master o/p salve i/p*/
#define PORTB_PIN6_DIR      0 /*MISO: Master i/p slave o/p*/
#define PORTB_PIN7_DIR      1 /*SCK : o/p at Master*/
